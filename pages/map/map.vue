<template>
    <div class="container">
        ...
        <van-action-sheet :show="show" @click-overlay="bindClose" close-on-click-overlay="true">
            <div class="content">
                <van-card title-class="title" :title="marker.name" :desc="marker.address" :price="marker.price + '元/度'">
                    <template #tags>
                        <div class="tag">
                            <div class="tagItem" v-if="marker.userId == null">公共充电桩</div>
                            <div class="tagItem" v-else>个人充电桩</div>
                            <div class="tagTips">限时免费停车</div>
                        </div>
                        <div class="tags">
                    ...
                    <template #footer>
                        <div class="footer">
                            ...
                            <van-button icon="guide-o" round size="small" type="primary" @click="navigation">导航</van-button>
                        </div>
                    </template>
                </van-card>
            </div>
        ...
        chargeStart() {
            ...
            uni.scanCode({
                success: function(res) {
                    that.marker = that.markers.find(item => {
                    ...
                    if (that.marker == null) {
                        ...
                        let data = JSON.stringify(that.marker);
                        uni.navigateTo({
